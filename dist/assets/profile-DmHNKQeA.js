import"./constants-BDf8nfUD.js";import{r as g,a as x}from"./main-B4YcYq6j.js";import{h as p,t as m,g as b}from"./listings-Ubj3QYyM.js";/* empty css              *//* empty css               */async function u(){const r=localStorage.getItem("loggedInUsername"),n=localStorage.getItem("profileUsername"),s=n||r;if(!s){console.error("no username found in localstorage");return}try{const e=await g(s),a=document.getElementById("user-profile-info");if(a){a.innerHTML=`
    <div class="flex flex-col items-center gap-4">
        ...
        <div class="font-text font-light text-[#727272]">${e.data.bio}</div>
                ...
                `;const d=await x(s),l=document.querySelector(".listingsGrid");l.innerHTML="";for(const t of d){const o=p(t.endsAt),c=m(t.endsAt),f=await b(t.bids),i=document.createElement("div");i.className="li-single-listing-content flex flex-col relative rounded-xl cursor-pointer",i.innerHTML=`
