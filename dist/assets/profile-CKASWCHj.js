import"./constants-BDf8nfUD.js";import{r as g,a as x}from"./main-btKrpKiE.js";import{h as p,t as m,g as b}from"./listings-UwpdXMdd.js";/* empty css              *//* empty css               */async function u(){const s=localStorage.getItem("loggedInUsername"),r=localStorage.getItem("profileUsername"),n=s||r;if(!n){console.error("no username found in localstorage");return}try{const e=await g(s),a=document.getElementById("user-profile-info");if(a){a.innerHTML=`
