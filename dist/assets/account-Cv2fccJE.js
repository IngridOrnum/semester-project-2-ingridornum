import"./input-CPdIg46K.js";import{r as s}from"./main-CYj49QAp.js";/* empty css               */async function a(){const e=localStorage.getItem("loggedInUsername"),t=await s(e),n=document.getElementById("userinfo-display");if(n){let i=function(){document.getElementById("open-profile-page").addEventListener("click",()=>{localStorage.setItem("profileUsername",t.data.name),window.location.href="../../../../profile/"})};n.innerHTML=`
