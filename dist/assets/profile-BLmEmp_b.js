import{r as g,a as u}from"./main-B8-7TrVe.js";import{h as m,t as b,g as v}from"./listings-B-nIuWtN.js";async function y(){const c=localStorage.getItem("loggedInUsername"),r=localStorage.getItem("profileUsername"),n=r||c;if(!n){console.error("no username found in localstorage");return}try{const e=await g(n),o=document.getElementById("user-profile-info");if(o){o.innerHTML=`
